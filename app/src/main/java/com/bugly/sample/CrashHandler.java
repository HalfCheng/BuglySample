...
public class CrashHandler implements Thread.UncaughtExceptionHandler {
    ...
    private static final String PATH = Environment.getExternalStorageDirectory().getPath() + "/wangwei/";
    ...
    public void uncaughtException(Thread thread, Throwable ex) {
        Toast.makeText(mContext, "马上崩溃", Toast.LENGTH_SHORT).show();
        Log.w("TAG", "马上崩溃");
        //延时退出
        try {
            thread.sleep(2000);
        ...
        if (mDefaultCrashHandler != null) {
            Toast.makeText(BaseApplication.getInstance(), "if", Toast.LENGTH_SHORT).show();
